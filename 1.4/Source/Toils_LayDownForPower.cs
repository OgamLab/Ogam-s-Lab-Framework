...
namespace Grimforge
{
    public static class Toils_LayDownForPower
    {
        ...
        public static Toil LayDown(TargetIndex chargingBuilding, bool hasBed, bool lookForOtherJobs = true, bool canSleep = true)
        {
            ...
            Building_ArmorChargingStation station = null;
            ...
            CompGFAACharger compGFAACharger = null;
            ...
            layDown.tickAction = delegate
            {
                ...
                else
                {
                    if (station == null)
                    {
                        station = (Building_ArmorChargingStation)curJob.GetTarget(chargingBuilding).Thing;
                    }
                }
                ...
                if (powerSource == null)
                {
                    if (targetBuilding.TryGetComp<CompGFAACharger>() != null)
                    {
